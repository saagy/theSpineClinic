...
CREATE POLICY "Doctors can view assigned or replacement patients only" ON public.patients FOR SELECT TO authenticated USING ((EXISTS (SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_role = 'doctor'::user_role AND staff_active = true)) AND (id IN (SELECT pd.patient_id FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR id IN (SELECT pd.patient_id FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)));
CREATE POLICY "Doctors can update their assigned or replacement/appointment patients" ON public.patients FOR UPDATE TO authenticated USING ((EXISTS (SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_role = 'doctor'::user_role AND staff_active = true)) AND (id IN (SELECT pd.patient_id FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR id IN (SELECT pd.patient_id FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true))) WITH CHECK ((EXISTS (SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_role = 'doctor'::user_role AND staff_active = true)) AND (id IN (SELECT pd.patient_id FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR id IN (SELECT pd.patient_id FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)));
...
CREATE POLICY "Select patient_documents policy" ON public.patient_documents FOR SELECT TO authenticated USING (EXISTS (SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_active = true AND (staff_role = ANY (ARRAY['super_admin'::user_role, 'receptionist'::user_role]) OR (staff_role = 'doctor'::user_role AND ( patient_id IN (SELECT pd.patient_id FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR patient_id IN (SELECT pd.patient_id FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR patient_id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR patient_id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)))));
CREATE POLICY "Insert patient_documents policy" ON public.patient_documents FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_active = true AND staff_id = patient_documents.uploaded_by AND (staff_role = ANY (ARRAY['super_admin'::user_role, 'receptionist'::user_role]) OR (staff_role = 'doctor'::user_role AND ( patient_id IN (SELECT pd.patient_id FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR patient_id IN (SELECT pd.patient_id FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR patient_id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR patient_id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)))));
CREATE POLICY "Update patient_documents policy" ON public.patient_documents FOR UPDATE TO authenticated USING (EXISTS (SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_active = true AND staff_role = ANY (ARRAY['super_admin'::user_role, 'receptionist'::user_role])));
...
CREATE POLICY "Insert patient_notes policy" ON public.patient_notes FOR INSERT TO authenticated WITH CHECK (EXISTS (SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_active = true AND staff_id = patient_notes.created_by AND (staff_role = ANY (ARRAY['super_admin'::user_role, 'receptionist'::user_role]) OR (staff_role = 'doctor'::user_role AND ( patient_id IN (SELECT pd.patient_id FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR patient_id IN (SELECT pd.patient_id FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR patient_id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR patient_id IN (SELECT a.patient_id FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)))));
...
CREATE POLICY "Select storage_objects policy" ON storage.objects FOR SELECT TO authenticated USING (bucket_id = 'patient-documents'::text AND EXISTS ( SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_active = true AND (staff_role = ANY (ARRAY['super_admin'::user_role, 'receptionist'::user_role]) OR (staff_role = 'doctor'::user_role AND ( path_tokens[1] IN (SELECT pd.patient_id::text FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR path_tokens[1] IN (SELECT pd.patient_id::text FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR path_tokens[1] IN (SELECT a.patient_id::text FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR path_tokens[1] IN (SELECT a.patient_id::text FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)))));
CREATE POLICY "Insert storage_objects policy" ON storage.objects FOR INSERT TO authenticated WITH CHECK (bucket_id = 'patient-documents'::text AND EXISTS ( SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_active = true AND (staff_role = ANY (ARRAY['super_admin'::user_role, 'receptionist'::user_role]) OR (staff_role = 'doctor'::user_role AND ( path_tokens[1] IN (SELECT pd.patient_id::text FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR path_tokens[1] IN (SELECT pd.patient_id::text FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR path_tokens[1] IN (SELECT a.patient_id::text FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR path_tokens[1] IN (SELECT a.patient_id::text FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)))));
...
CREATE POLICY "Delete storage_objects policy" ON storage.objects FOR DELETE TO authenticated USING (bucket_id = 'patient-documents'::text AND EXISTS ( SELECT 1 FROM public.get_auth_staff_profile() WHERE staff_active = true AND (staff_role = ANY (ARRAY['super_admin'::user_role, 'receptionist'::user_role]) OR (staff_role = 'doctor'::user_role AND ( path_tokens[1] IN (SELECT pd.patient_id::text FROM patient_doctors pd WHERE pd.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile())) OR path_tokens[1] IN (SELECT pd.patient_id::text FROM patient_doctors pd JOIN doctor_replacements dr ON dr.absent_doctor_id = pd.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE) OR path_tokens[1] IN (SELECT a.patient_id::text FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id WHERE ad.doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND ad.is_active = true) OR path_tokens[1] IN (SELECT a.patient_id::text FROM appointments a JOIN appointment_doctors ad ON ad.appointment_id = a.id JOIN doctor_replacements dr ON dr.absent_doctor_id = ad.doctor_id WHERE dr.covering_doctor_id = (SELECT get_auth_staff_profile.staff_id FROM public.get_auth_staff_profile()) AND dr.replacement_date = CURRENT_DATE AND ad.is_active = true)))));
