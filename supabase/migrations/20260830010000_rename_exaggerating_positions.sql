-- Migration: Rename exacerbating_positions to exaggerating_positions on patient_programs table and update RPC functions
ALTER TABLE public.patient_programs RENAME COLUMN exacerbating_positions TO exaggerating_positions;
