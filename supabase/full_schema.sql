-- Canonical schema snapshot through the 2026-09-09 patient deletion migration.
...
ALTER FUNCTION public.create_patient_with_doctors(text, text, public.clinic_location, uuid, uuid[]) SET search_path = public, pg_temp;
...
REVOKE EXECUTE ON FUNCTION public.create_patient_with_doctors(text, text, public.clinic_location, uuid, uuid[]) FROM PUBLIC, anon;
