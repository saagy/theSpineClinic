    ...
    final List<Widget> additional = [
      ...
      Wrap(
        ...
        children: [
          ...
          AppFilterChip(
            label: AppStrings.normalPtSession,
            isActive: _selectedType == AppointmentType.normalPtSession,
            onTap: () => setState(() => _selectedType = AppointmentType.normalPtSession),
          ),
          AppFilterChip(
            label: AppStrings.spinalTractionSession,
            isActive: _selectedType == AppointmentType.spinalTractionSession,
            onTap: () =>
                setState(() => _selectedType = AppointmentType.spinalTractionSession),
          ),
          AppFilterChip(
            label: AppStrings.initialAssessment,
            isActive: _selectedType == AppointmentType.initialAssessment,
            onTap: () => setState(() => _selectedType = AppointmentType.initialAssessment),
          ),
          AppFilterChip(
            label: AppStrings.reassessment,
            isActive: _selectedType == AppointmentType.reassessment,
            onTap: () => setState(() => _selectedType = AppointmentType.reassessment),
          ),
        ],
      ),
    ];
