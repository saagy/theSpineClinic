...
class _NewAppointmentScreenState extends ConsumerState<NewAppointmentScreen> {
  ...
  bool _isLoadingDoctors = false, _isSubmitting = false, _usePackage = true;
  ...
  Future<void> _submitForm() async {
    ...
    if (!isFormValid || _dateErrorText != null || _timeErrorText != null || _daysErrorText != null) return;
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!asyncUser.isLoading && (user == null || user.role == UserRole.doctor)) {
        AppSnackbar.show(context, message: AppStrings.accessDenied, variant: AppSnackbarVariant.error);
        context.pop();
      }
    });
    if (asyncUser.isLoading || user == null || user.role == UserRole.doctor) {
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      BookingFormFields(
                        ...
                        patientIdValidator: (val) =>
                            (val == null || val.trim().length != 36) ? AppStrings.patientRequired : null,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Switch(
                            value: _usePackage,
                            onChanged: (val) => setState(() => _usePackage = val),
                ...
                if (_assignedDoctors.isNotEmpty) ...[
                  ...
                  SelectedDoctorsChips(doctors: _assignedDoctors, onRemoveDoctor: (doc) => setState(() {
                    _assignedDoctors = _assignedDoctors.where((d) => d.id != doc.id).toList();
                  })),
                ],
                if (isPatientValid) ...[
                  const SizedBox(height: AppSizes.p24),
