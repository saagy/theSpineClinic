...
/// Top header banner displaying program status, creation metadata, and clinical actions.
        ...
        children: [
          Expanded(
            child: Wrap(
              ...
              children: [
                Text(AppStrings.program, style: AppTextStyles.headingSmall.copyWith(color: cs.onSurface)),
            ...
            PopupMenuButton<ProgramStatus>(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(AppStrings.setStatus, style: AppTextStyles.captionBold.copyWith(color: cs.primary)),
