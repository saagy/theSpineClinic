...
import 'package:spine_clinic_app/features/patient/presentation/widgets/patient_note_actions_menu.dart';
    ...
    return Container(
      ...
      child: Material(
        ...
        child: GestureDetector(
          onLongPressStart: canModify
              ? (d) => PatientNoteActionsMenu.showContextMenu(
                    context,
                    d.globalPosition,
                    onEdit: () => _showEditNoteSheet(context),
                    onDelete: () => _confirmDeleteNote(context, ref),
                  )
              : null,
          onSecondaryTapDown: canModify
              ? (d) => PatientNoteActionsMenu.showContextMenu(
                    context,
                    d.globalPosition,
                    onEdit: () => _showEditNoteSheet(context),
