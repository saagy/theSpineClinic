...
mixin _$Patient {
 ...
 String get id;@JsonKey(name: 'full_name') String get fullName;@JsonKey(name: 'phone_number') String get phoneNumber; String? get program; ClinicLocation get clinic;@JsonKey(name: 'session_balance') int get sessionBalance;@JsonKey(name: 'traction_balance') int get tractionBalance;@JsonKey(name: 'created_by') String? get createdBy;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'next_visit_date') DateTime? get nextVisitDate;@JsonKey(includeFromJson: false, includeToJson: false) DateTime? get lastAppointmentDate;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fullName,phoneNumber,program,clinic,sessionBalance,tractionBalance,createdBy,createdAt,nextVisitDate,lastAppointmentDate);

@override
String toString() {
  return 'Patient(id: $id, fullName: $fullName, phoneNumber: $phoneNumber, program: $program, clinic: $clinic, sessionBalance: $sessionBalance, tractionBalance: $tractionBalance, createdBy: $createdBy, createdAt: $createdAt, nextVisitDate: $nextVisitDate, lastAppointmentDate: $lastAppointmentDate)';
}
...
/// Create a copy of Patient
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = null,Object? phoneNumber = null,Object? program = freezed,Object? clinic = null,Object? sessionBalance = null,Object? tractionBalance = null,Object? createdBy = freezed,Object? createdAt = null,Object? nextVisitDate = freezed,Object? lastAppointmentDate = freezed,}) {
...
switch (_that) {
case _Patient() when $default != null:
return $default(_that.id,_that.fullName,_that.phoneNumber,_that.program,_that.clinic,_that.sessionBalance,_that.tractionBalance,_that.createdBy,_that.createdAt,_that.nextVisitDate,_that.lastAppointmentDate);case _:
  return orElse();
...
class _Patient implements Patient {
  const _Patient({required this.id, @JsonKey(name: 'full_name') required this.fullName, @JsonKey(name: 'phone_number') required this.phoneNumber, this.program, required this.clinic, @JsonKey(name: 'session_balance') this.sessionBalance = 0, @JsonKey(name: 'traction_balance') this.tractionBalance = 0, @JsonKey(name: 'created_by') this.createdBy, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'next_visit_date') this.nextVisitDate, @JsonKey(includeFromJson: false, includeToJson: false) this.lastAppointmentDate});
...
/// Create a copy of Patient
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fullName = null,Object? phoneNumber = null,Object? program = freezed,Object? clinic = null,Object? sessionBalance = null,Object? tractionBalance = null,Object? createdBy = freezed,Object? createdAt = null,Object? nextVisitDate = freezed,Object? lastAppointmentDate = freezed,}) {
