  ...
  static ClinicColors fromPalette(AppPalette palette, {bool isDark = false}) {
    if (isDark) {
      return ClinicColors(
        ...
        successContainer: const Color(0xFF0C2D23),
        warning: const Color(0xFFFBBF24),
        warningContainer: const Color(0xFF352308),
        info: const Color(0xFF38BDF8),
        infoContainer: const Color(0xFF0C2B40),
        neutral: const Color(0xFF94A3B8),
        neutralContainer: const Color(0xFF1E2836),
        checkedInContainer: const Color(0xFF0D2A20),
        checkedInOutline: const Color(0xFF18533F),
        ...
        overlayScrim: const Color(0x80000000),
      );
    }
