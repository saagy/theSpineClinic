...
abstract final class AppStrings {
  static const String patientVisits = "Upcoming visits";
  static const String patientNotEmpty =
      "Only patients with no appointments, payments, programs, medical history, notes, documents or session balances can be deleted.";
  static String pastAppointmentsCount(int count) => "Past and cancelled appointments ($count)";
  static const String filterSort = "Filter & sort";
  // Patient workspace
  static const String patientOverview = 'Overview';
  static const String patientRecord = 'Patient record';
  static const String closePatientPanel = 'Close';
  ...
  static const String noUpcomingAppointment = 'No upcoming appointment';
  static const String viewAppointment = 'View appointment';
  static const String viewPayments = 'View payments';
  static const String noOutstandingPayments = 'No outstanding payments';
  static const String availableSessions = 'Session balances';
  static const String patientBalanceContext = 'Patient balance across all programs';
  static const String historyNotRecorded = 'Medical history has not been recorded.';
  static const String noConditionsRecorded = 'No conditions recorded in this history.';
  static const String noActivePrograms = 'No active programs.';
  static const String noActivePlan = 'No active treatment plan';
  static const String registered = 'Registered';
  static const String viewAll = 'View all';
  static const String loadingPatientSection = 'Loading patient information';
  static const String patientSectionError = 'This information could not load.';
  static const String paymentsReadOnly = 'Payment changes require payment access.';
  static const String documentPreviewUnavailable = 'Preview unavailable';
  static const String showMoreRecords = 'Show more';
  static const String patientPrice = 'Price';
  static const String patientPaid = 'Paid';
  ...
  static const String unsupportedDocumentType = 'This file type is not supported for in-app viewing.';
  ...
  static const String documentNameTooLong = 'Document names cannot exceed 255 characters.';
  static const String deleteDocumentTitle = 'Delete Document';
  static const String confirmDeleteDocument = 'Are you sure you want to permanently delete this document?';
  ...
  static const String appointmentCancelledDescription = 'Appointment cancelled.';
  ...
  static const String confirmCheckIn = 'Check in this patient for their appointment?';
  ...
  static const String noAffectedAppointments = 'No appointments found for this doctor on this date.';
  ...
  static const String sessionsRangeError = 'Number of sessions must be between 1 and 24.';
  static const String sessionsRangeValidator = 'Must be between 1 and 24 sessions';
  static const String doctorListTimeout = 'Doctor list took too long. Select manually.';
  ...
  static String packageDeficitMessage(int deficit) => 'Package Deficit: $deficit session(s) overdrawn.';

  /// Leftover message shown when booking leaves a positive remainder.
  static String projectedLeftoverMessage(int leftover) => 'Projected Leftover Balance: $leftover session(s).';
  ...
  static const String paymentLoginRequired = 'Must be logged in to manage payments.';
  ...
  static const String editPaymentHint = 'To record a new collection, use the "Collect Due" button.';
  static const String partialPaymentHelpText = 'Turn on if the patient paid only part of the total.';
  ...
  static const String totalAmountPositive = 'Total Amount must be greater than zero.';
  static const String amountExceedsServiceTotal = 'Amount paid cannot exceed Total Amount.';
  static const String amountExceedsRemainingDue = 'Amount cannot exceed remaining due.';
  static const String customReasonRequiredMessage = 'Please enter a custom reason.';
  static const String validPtSessionsMessage = 'Enter a valid PT session amount or leave it empty.';
  static const String validTractionSessionsMessage = 'Enter a valid traction amount or leave it empty.';
  ...
  static const String addBalanceAssessmentDisabled = 'Assessment payments do not add package balances.';
  static const String noRemainingDueSaved = 'No remaining due. This payment will be saved as paid in full.';
  static const String collectionRecordedSuccess = 'Collection recorded successfully.';
  ...
  static String confirmRecordPayment(String amount, String reason) => 'Record $amount for $reason?';
  static String confirmRecordPaymentWithCredits(String amount, String reason, int pt, int traction) =>
      'Record $amount for $reason and add $pt PT + $traction traction?';
  static String confirmCollectDue(String amount) => 'Record collection of $amount for this due payment?';
  static String confirmEditPaymentPaidInFull() => 'Save changes? This payment will have no remaining due.';
  ...
  static const String errorUpdatingSessionStatus = 'Error updating session status';
  ...
  static const String staffAdminPermissionDenied = 'Only super admins can manage staff accounts.';
  ...
  static const String staffRejectedSuccess = 'Application rejected and deleted.';
  ...
  static const String noPendingApplications = 'No pending staff applications found.';
  ...
  static const String scheduleDensitySubtitle = 'Standard or compact schedule and booking cards';
  ...
  static String scheduleDaySemantics(String date, int appointmentCount, {required bool selected}) =>
  ...
  static String appointmentCountSummary(int count) => '$count appointment${count == 1 ? '' : 's'}';
  ...
  static const String atLeastOneDoctorRequired = 'At least one doctor is required.';
  static const String unableToLoadDoctors = 'Unable to load doctors — tap refresh icon to retry';
  ...
  static const String noScheduleForDate = 'No appointments booked for this date.';
  ...
  static const String stopFollowUpMessage = 'This patient will no longer appear in the booking list.';
  ...
  static const String pastScheduledNeedsAction = 'Missed appointment';
  ...
  static const String noReplaceableAppointments = 'No replaceable appointments remain.';
  static const String replacementSelectionRequired = 'Select at least one doctor and appointment.';
  static String replaceDoctorTitle(String name) => 'Replace $name';
  static String replaceOnAppointments(int count) => 'Replace on $count appointment${count == 1 ? '' : 's'}';
  ...
  static String doctorsSelected(int count) => '$count doctor${count == 1 ? '' : 's'} selected';
  ...
  static String replacementDayPickerSubtitle(String name) => '$name will be away on:';
  ...
  static const String selectAbsentDoctorSubtitle = 'Choose which doctor\u2019s day you need to reassign.';
  static const String noDoctorsWithTodayLoad = 'No doctors have appointments today.';
  static const String cannotReplaceWithSelf = 'A doctor cannot cover for themselves.';
  ...
  static const String imagingNotesHint = 'X-ray, MRI, CT scan interpretation…';
  ...
  static const String clinicalAssessmentAndPlan = 'Clinical assessment & active treatment plan';
  ...
  static String scanCountLabel(int count) => '$count ${count == 1 ? 'Scan' : 'Scans'}';
  ...
  static const String savingClinicalRecord = 'Saving…';
  static const String defaultPlanName = 'Plan 1';
  static const String planNameRequired = 'Enter a plan name.';
  static const String clinicalFindingsNotRecorded = 'Clinical findings have not been recorded.';
  ...
  static const String planNotesHint = 'Enter specific treatment instructions, precautions, or notes...';
  static const String planNameHint = 'e.g. Plan 1 - Acute Phase';
  static const String modalityNotes = 'Modality Notes';
  static const String modalityNotesHint = 'Intensity, parameters, or specific technique notes...';
  static const String activePlanToggle = 'Set as Active Plan';
  static const String activePlanSubtitle = 'Active plan will be executed during patient visits';
  ...
  static String modalitiesCount(int count) => '$count ${count == 1 ? 'Modality' : 'Modalities'}';
  static String regionsCount(int count) => '$count ${count == 1 ? 'Region' : 'Regions'}';
  static String durationFormat(int min) => '$min min';
  static String totalDurationFormat(int min) => '$min min total';
  static String conditionsCount(int count) => '$count ${count == 1 ? 'Condition' : 'Conditions'}';
  ...
  static const String noConditionsSelected = 'Select at least one injury to define the affected regions.';
  ...
  static const String selectConditionRequired = 'Please select at least one condition/injury.';
