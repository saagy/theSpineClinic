    ...
    return Stack(
      children: [
        ...
        if (widget.isLoading) ...[
          AbsorbPointer(
            absorbing: true,
            child: Container(color: cs.scrim.withAlpha(77)),
          ),
          Center(
            child: Column(
              ...
              children: [
                ...
                if (_showEscapeHatch) ...[
                  ...
                  _EscapeHatch(colorScheme: cs, onEscape: _onEscape),
                ],
              ],
            ),
          ),
...
class _EscapeHatch extends StatelessWidget {
  const _EscapeHatch({required this.colorScheme, required this.onEscape});
